...
<body>
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
        <div class="container-fluid">
            ...
            <!-- Brand -->
            <a class="navbar-brand pt-0" href="{{ route('dashboard') }}">PERSURATAN</a>
            <!-- User -->
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('users.index') }}">
                            <i class="ni ni-planet text-blue"></i> Users
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('nama_tandatgn.index') }}">
                            <i class="ni ni-pin-3 text-orange"></i> Nama Tanda Tangan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('kepala_surat.index') }}">
                            <i class="ni ni-single-02 text-yellow"></i> Kepala Surat
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('surat_keluar.index') }}">
                            <i class="ni ni-bullet-list-67 text-red"></i> Surat Keluar
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('surat_masuk.index') }}">
                            <i class="ni ni-key-25 text-info"></i> Surat Masuk
                        </a>
                    </li>
                </ul>
            </div>
