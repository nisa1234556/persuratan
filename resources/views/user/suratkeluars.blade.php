                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">ID Kops: {{ $suratKeluar->id }}</h5>
                                        <p class="card-text"><strong>Tanggal:</strong> {{ $suratKeluar->tanggal }}</p>
                                        <p class="card-text"><strong>No Surat:</strong> {{ $suratKeluar->no_surat }}</p>
                                        <p class="card-text"><strong>Perihal:</strong> {{ $suratKeluar->perihal }}</p>
                                        <p class="card-text"><strong>Tujuan:</strong> {{ $suratKeluar->tujuan }}</p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
