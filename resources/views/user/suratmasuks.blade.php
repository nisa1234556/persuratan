...
<body class="">
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
        <div class="container-fluid">
            ...
            <!-- Brand -->
            <a class="navbar-brand pt-0" href="./index.html">PERSURATAN</a>
            <!-- User -->
        ...
        <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
            <div class="container-fluid">
                <div class="header-body">
                    <!-- Card stats -->
                    <@section('content') @section('content') <div class="container">
                        <div class="row">
                            @foreach ($suratMasuks as $suratMasuk)
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $suratMasuk->no_surat }}</h5>
                                        <h6 class="card-subtitle mb-2 text-muted">{{ $suratMasuk->tanggal }}</h6>
                                        <p class="card-text">Asal Surat: {{ $suratMasuk->asal_surat }}</p>
                                        <p class="card-text">Perihal: {{ $suratMasuk->perihal }}</p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
